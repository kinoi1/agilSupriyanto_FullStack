...
(function(h) {
    ...
    function O(a) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1);
            ...
            // tag_img = '<img src="'+host+'/aset/img/icon.png" height="80"> <h4>Data not found</h4>';
            tag_img = '<h4>Data not found</h4>';
    ...
    s("columns().visible()", "column().visible()", function(a, b) {
        return this.iterator("column", function(c, d) {
            ...
            if (a !== k && f.bVisible !== a) {
                if (a) {
                    var l = h.inArray(!0, G(e, "bVisible"), d + 1);
                    j = 0;
                    for (i = g.length; j <
                        i; j++) n = g[j].nTr, e = g[j].anCells, n && n.insertBefore(e[d], e[l] || null)
                } else h(G(c.aoData, "anCells", d)).detach();
                f.bVisible = a;
                ea(c, c.aoHeader);
                ea(c, c.aoFooter);
                (b === k || b) && U(c);
