...
var save_method = "add";
var table;
var url_list    = host + "city/list_data/";
var url_edit    = host + "city/edit/";
var url_hapus   = host + "city/delete/";
var url_simpan  = host + "city/save/";
var addressno   = 0;
var contactno   = 0;
var modul       = "";
var app         = "";
    ...
    $.ajax({
        ...
        success: function(json){
            ...
            if(json.Status){
                ...
                NextID = a.NextID;
                PrevID = a.PrevID;
                $("#form [name=CityID]").val(a.CityID);
                $("#form [name=CodeCity]").val(a.Code);
...
function save(element)
{
    ...
    if(count_save == 0){
        ...
        method = dt.method;
        url = host;
        url = host + 'city/save/'+save_method;
        $.ajax({
            url : url,
            type: "POST",
            data: $('#form').serialize(),
            ...
            success: function(json)
            {
                if(json.Status){
                    ...
                    if(method == "close"){
                        ...
                        save_method = "update";
                        $("#form [name=CityID]").val(json.CityID);
